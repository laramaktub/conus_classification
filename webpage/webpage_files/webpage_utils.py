# -*- coding: utf-8 -*-
"""
Conus Classification webpage auxiliary functions
...
def label_list_to_html(labels_file):
    ...
    <div class="container">
        <section class="header">
            <h1 class="center"  style="margin-top: 25%">Automated Conus Recognition</h1>
        </section>
    ...
    index = np.argwhere(labels=="The image is probably not a conus")
